...
public class MovieProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.product/products" will map to the
        ...
        // For example, "content://com.example.android.product/products/3" matches, but
        // "content://com.example.android.product/products" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            /*case MOVIE_ID:
                ...
                // For an example URI such as "content://com.example.android.product/products/3",
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
       ...
       /* String name = values.getAsString(MovieEntry.COLUMN_NAME);
        if (name.matches("")) {
            throw new IllegalArgumentException(getContext().getResources().getString(R.string.editor_error_msg_name_requires));
        }*/
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        /*if (values.containsKey(MovieEntry.COLUMN_NAME)) {
            String name = values.getAsString(MovieEntry.COLUMN_NAME);
            if (name.matches("")) {
                throw new IllegalArgumentException(getContext().getResources().getString(R.string.editor_error_msg_name_requires));
            }
